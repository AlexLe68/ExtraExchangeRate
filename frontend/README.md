# ExtraCurrencyExchange- Frontend Code

This directory contains the frontend code for the ExtraCurrencyExchange plugin.
...
This will compile the frontend into the `../extracurrencyexchange/static` directory (ready for distribution).
